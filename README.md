...
С одной ошибкой 
|Speller           |Точность % (С токенайзером)| Однопоток Скорость запрос/секунда (запрос/миллисекунда)  | Многопоток Скорость запрос/секунда (запрос/миллисекунда)   | Память Мб 		 |  
|:------------------:|:---------:|:----------------------------------------------------------:|:-----------------------------------------------------------:|:-------------------:|   
...
С токенайзером - процент успешных исправлений спеллера, при сравнении лемм предложенного варианта спеллера и эталонного запроса. Лемматизация после получения исправления для приведения к одной форме для тестов.  
